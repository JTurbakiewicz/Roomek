...
class OlxSpiderMain(scrapy.Spider):
    ...
    def parse_otodom_offer(self, response):
        ...
        OfferItem_loader.add_value('offer_type', response.meta['offer_type'])
        OfferItem_loader.add_value('offer_url', response)
        OfferItem_loader.add_xpath('offer_name', '//*[@id="root"]/div/article/div[1]/header/div[1]/h1/text()')
        ...
        OfferItem_loader.add_xpath('price', '//*[@id="root"]/div/article/div[1]/header/div[3]/div[1]/text()')
        OfferItem_loader.add_xpath('date_of_the_offer', '//*[@id="root"]/div/article/div[2]/div[1]/div[3]/div/div[2]/text()[2]')
        OfferItem_loader.add_xpath('offer_id', '//*[@id="root"]/div/article/div[2]/div[1]/div[3]/div/div[1]/text()')
        OfferItem_loader.add_xpath('offer_text', '//*[@id="root"]/div/article/div[2]/div[1]/section[2]/div/div[1]')
        OfferItem_loader.add_xpath('price_per_m2', '//*[@id="root"]/div/article/div[1]/header/div[3]/div[2]/text()')
        ...
        OfferItem_loader.add_xpath('district', '//*[@id="root"]/div/article/div[1]/header/div[1]/div/div/a/text()')
