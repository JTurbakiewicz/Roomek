...
offer_scheme = {
    "offer_url": {"db": "varchar(700) NOT NULL", 'item_loaders': ['response_to_string'], 'scraping_path_olx': '',
                  'misc': ['Oferta od'], 'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': False},
    "city": {"db": "varchar(50) NOT NULL", 'item_loaders': [], 'scraping_path_olx': '', 'misc': [],
             'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': False},
    ...
    "offer_name": {"db": "varchar(200)", 'item_loaders': ['remove_html_tags', 'remove_unnecessary_spaces'],
                   ...
                   'scraping_path_olxroom': '//*[@id="offerdescription"]/div[2]/h1/text()', 'is_feature': False},
    "offer_thumbnail_url": {"db": "varchar(400)", 'item_loaders': ['find_image_url'],
                            ...
                            'scraping_path_olxroom': '//*[@id="photo-gallery-opener"]/img', 'is_feature': False},
    "price": {"db": "int(1)", 'item_loaders': ['just_numbers', 'integer_the_price'],
              ...
              'scraping_path_olxroom': '//*[@id="offeractions"]/div[1]/strong/text()', 'is_feature': False},
    ...
    "date_of_the_offer": {"db": "DATETIME",
                          ...
                          'scraping_path_olxroom': '//*[@id="offerdescription"]/div[2]/div[1]/em', 'is_feature': False},
    ...
    "offer_text": {"db": "LONGTEXT",
                   ...
                   'scraping_path_olxroom': '//*[@id="textContent"]', 'is_feature': False},
    "offer_from": {"db": "varchar(25)", 'item_loaders': ['remove_html_tags', 'translate'], 'scraping_path_olx': '',
                   'misc': [], 'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': True},
    "apartment_level": {"db": "smallint(1)",
                        ...
                        'scraping_path_olxroom': '', 'is_feature': True},
    "furniture": {"db": "BOOLEAN", 'item_loaders': ['remove_html_tags', 'furniture'], 'scraping_path_olx': '',
                  'misc': ['Umeblowane'], 'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': True},
    ...
    "type_of_market": {"db": "varchar(25)", 'item_loaders': ['remove_html_tags', 'translate'], 'scraping_path_olx': '',
                       'misc': ['Rynek'], 'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': True},
    "security_deposit": {"db": "smallint(1)", 'item_loaders': [], 'scraping_path_olx': '', 'misc': ['Kaucja'],
                         'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': True},
...
query_scheme = {
    "query_no": {"db": "int(1) NOT NULL", 'is_feature': False, 'comparator': '='},
    "facebook_id": {"db": "char(100) NOT NULL", 'is_feature': False, 'comparator': '='},
    "city": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "housing_type": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "business_type": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "price": {"db": "int(1)", 'is_feature': True, 'comparator': '<='},
    "street": {"db": "varchar(50)", 'is_feature': False, 'comparator': '='},
    "district": {"db": "varchar(50)", 'is_feature': False, 'comparator': '='},
    "date_of_the_offer": {"db": "DATETIME", 'is_feature': False, 'comparator': '='},
    "offer_from": {"db": "varchar(25)", 'is_feature': True, 'comparator': '='},
    "apartment_level": {"db": "smallint(1)", 'is_feature': True, 'comparator': '='},
    "furniture": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "type_of_building": {"db": "varchar(25)", 'is_feature': True, 'comparator': '='},
    "area": {"db": "smallint(1)", 'is_feature': True, 'comparator': '>'},
    "amount_of_rooms": {"db": "int(1)", 'is_feature': True, 'comparator': '>='},
    "additional_rent": {"db": "int(1)", 'is_feature': True, 'comparator': '<='},
    "price_per_m2": {"db": "int(1)", 'is_feature': True, 'comparator': '<='},
    "type_of_market": {"db": "varchar(25)", 'is_feature': True, 'comparator': '='},
    "security_deposit": {"db": "smallint(1)", 'is_feature': True, 'comparator': '<='},
    "building_material": {"db": "varchar(25)", 'is_feature': True, 'comparator': '='},
    "windows": {"db": "varchar(25)", 'is_feature': True, 'comparator': '='},
    "heating": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "building_year": {"db": "SMALLINT(1)", 'is_feature': True, 'comparator': '>='},
    "fit_out": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "ready_from": {"db": "DATETIME", 'is_feature': True, 'comparator': '='},
    "type_of_ownership": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "rental_for_students": {"db": 'BOOLEAN', 'is_feature': True, 'comparator': '='},
    "type_of_room": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "preferred_locator": {"db": "varchar(50)", 'is_feature': True, 'comparator': '='},
    "non_smokers_only": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "internet": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "cable_tv": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "closed_terrain": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "monitoring_or_security": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "entry_phone": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "antibulglar_doors_windows": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "alarm_system": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "antibulglar_blinds": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "dishwasher": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "cooker": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "fridge": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "oven": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "washing_machine": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "tv": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "elevator": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "phone": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "AC": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "garden": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "bathtub": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "utility_room": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "parking_space": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "terrace": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "balcony": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "separate_kitchen": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "basement": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "virtual_walk": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "two_level_apartment": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "connecting_room": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
    "pet_friendly": {"db": "BOOLEAN", 'is_feature': True, 'comparator': '='},
}
...
regex_scheme = {
    ...
    # "offer_id": {'regex': []},
    "offer_from": {'private': ['bezpo[sś]rednio', 'od w[lł]a[śs]ciciela'],
    ...
    "furniture": {True: ['[^nie]umeblowan[ey]', 'z umeblowan(.{,10) ', '[^nie]wyposa[zż]on[ey]'],
                  False: ['nieumeblowan[ey]', 'do umeblowania', 'niewyposa[zż]on[ey]']},
    "type_of_building": {'regex': []},
    "area": {'m2': [r'(\d{1,})(.{,1})m(.{,2})2']},
    "amount_of_rooms": {1: ['kawalerka', ''],
                        2: ['2 pokoje', '2[-\s]?pokojowe', '2 pok'],
                        3: ['3 pokoje', '3[-\s]?pokojowe', '3 pok'],
                        4: ['4 pokoje', '4[-\s]?pokojowe', '4 pok']},
    ...
    "heating": {'regex': []},
    "building_year": {'regex': []},
    "fit_out": {'raw': ['do wyko(.*)czenia', 'stan deweloperski'], 'refurbished': ['wyremontowan[ye]', 'po remoncie'],
