...
offer_scheme = {
    "offer_url": {"db": "varchar(700) NOT NULL", 'item_loaders': ['response_to_string'], 'scraping_path_olx' : '', 'misc' : ['Oferta od']},
    ...
    "offer_name": {"db": "varchar(200)", 'item_loaders': ['remove_html_tags', 'remove_unnecessary_spaces'], 'scraping_path_olx' : '//*[@id="offerdescription"]/div[2]/h1/text()', 'misc' : []},
    "offer_thumbnail_url": {"db": "varchar(400)", 'item_loaders': ['find_image_url'], 'scraping_path_olx' : '//*[@id="photo-gallery-opener"]/img', 'misc' : []},
    "price": {"db": "int(1)", 'item_loaders': ['just_numbers','integer_the_price'], 'scraping_path_olx' : '//*[@id="offeractions"]/div[1]/strong/text()', 'misc' : []},
    "street": {"db": "varchar(50)", 'item_loaders': ['street_it'], 'scraping_path_olx' : '', 'misc' : []},
    "district": {"db": "varchar(50)", 'item_loaders': ['district'], 'scraping_path_olx' : '//*[@id="offerdescription"]/div[2]/div[1]/a/strong/text()', 'misc' : []},
    "date_of_the_offer": {"db": "DATETIME", 'item_loaders': ['remove_html_tags','remove_unnecessary_spaces', 'datetime_it_OLX'], 'scraping_path_olx' : '//*[@id="offerdescription"]/div[2]/div[1]/em', 'misc' : []},
    "offer_id": {"db": "LONGTEXT", 'item_loaders': ['just_numbers'], 'scraping_path_olx' : '//*[@id="offerdescription"]/div[2]/div[1]/em/small/text()', 'misc' : []},
    "offer_text": {"db": "LONGTEXT", 'item_loaders': ['remove_unnecessary_spaces', 'remove_html_tags', 'swap_unnecessary_spaces'], 'scraping_path_olx' : '//*[@id="textContent"]', 'misc' : []},
    "offer_from": {"db": "varchar(25)", 'item_loaders': ['remove_html_tags','translate'], 'scraping_path_olx' : '', 'misc' : []},
    "apartment_level": {"db": "smallint(1)", 'item_loaders': ['remove_html_tags','word_to_numbers','just_numbers','integer_the_price'], 'scraping_path_olx' : '', 'misc' : ['Poziom']},
    "furniture": {"db": "BOOLEAN", 'item_loaders': ['remove_html_tags', 'furniture'], 'scraping_path_olx' : '', 'misc' : ['Umeblowane']},
    "type_of_building": {"db": "varchar(25)", 'item_loaders': ['remove_html_tags','translate'], 'scraping_path_olx' : '', 'misc' : ['Rodzaj zabudowy']},
    "area": {"db": "smallint(1)", 'item_loaders': ['remove_html_tags','just_numbers','integer_the_price'], 'scraping_path_olx' : '', 'misc' : ['Powierzchnia']},
    "amount_of_rooms": {"db": "int(1)", 'item_loaders': ['remove_html_tags','word_to_numbers','just_numbers','integer_the_price'], 'scraping_path_olx' : '', 'misc' : ['Liczba pokoi']},
    "additional_rent": {"db": "int(1)", 'item_loaders': ['remove_html_tags','just_numbers','integer_the_price'], 'scraping_path_olx' : '', 'misc' : ['Czynsz (dodatkowo)']},
    "price_per_m2": {"db": "int(1)", 'item_loaders': ['remove_html_tags','just_numbers','integer_the_price'], 'scraping_path_olx' : '', 'misc' : ['Cena za m²']},
    "type_of_market": {"db": "varchar(25)", 'item_loaders': ['remove_html_tags', 'translate'], 'scraping_path_olx' : '', 'misc' : ['Rynek']},
    "security_deposit": {"db": "smallint(1)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "building_material": {"db": "varchar(25)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "windows": {"db": "varchar(25)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "heating": {"db": "varchar(50)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "building_year": {"db": "SMALLINT(1)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "fit_out": {"db": "varchar(50)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "ready_from": {"db": "DATETIME", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "type_of_ownership": {"db": "varchar(50)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "rental_for_students": {"db": "varchar(25)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    ...
    "type_of_room": {"db": "varchar(50)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
    "preferred_locator": {"db": "varchar(50)", 'item_loaders': [], 'scraping_path_olx' : '', 'misc' : []},
