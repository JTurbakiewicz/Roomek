...
query_scheme = {
    "query_no": {"db": "int(1) NOT NULL", 'is_feature': False},
    "facebook_id": {"db": "char(100) NOT NULL", 'is_feature': False},
    "city": {"db": "varchar(50)", 'is_feature': False},
    "housing_type": {"db": "varchar(50)", 'is_feature': False},
    "business_type": {"db": "varchar(50)", 'is_feature': False},
    "price": {"db": "int(1)", 'is_feature': False},
    "street": {"db": "varchar(50)", 'is_feature': False},
    "district": {"db": "varchar(50)", 'is_feature': False},
    "date_of_the_offer": {"db": "DATETIME", 'is_feature': False},
    "offer_from": {"db": "varchar(25)", 'is_feature': True},
    "apartment_level": {"db": "smallint(1)", 'is_feature': True},
    "furniture": {"db": "BOOLEAN", 'is_feature': True},
    "type_of_building": {"db": "varchar(25)", 'is_feature': True},
    "area": {"db": "smallint(1)", 'is_feature': True},
    "amount_of_rooms": {"db": "int(1)", 'is_feature': True},
    "additional_rent": {"db": "int(1)", 'is_feature': True},
    "price_per_m2": {"db": "int(1)", 'is_feature': True},
    "type_of_market": {"db": "varchar(25)", 'is_feature': True},
    "security_deposit": {"db": "smallint(1)", 'is_feature': True},
    "building_material": {"db": "varchar(25)", 'is_feature': True},
    "windows": {"db": "varchar(25)", 'is_feature': True},
    "heating": {"db": "varchar(50)", 'is_feature': True},
    "building_year": {"db": "SMALLINT(1)", 'is_feature': True},
    "fit_out": {"db": "varchar(50)", 'is_feature': True},
    "ready_from": {"db": "DATETIME", 'is_feature': True},
    "type_of_ownership": {"db": "varchar(50)", 'is_feature': True},
    "rental_for_students": {"db": 'BOOLEAN', 'is_feature': True},
    "type_of_room": {"db": "varchar(50)", 'is_feature': True},
    "preferred_locator": {"db": "varchar(50)", 'is_feature': True},
    "non_smokers_only": {"db": "BOOLEAN", 'is_feature': True},
    "internet": {"db": "BOOLEAN", 'is_feature': True},
    "cable_tv": {"db": "BOOLEAN", 'is_feature': True},
    "closed_terrain": {"db": "BOOLEAN", 'is_feature': True},
    "monitoring_or_security": {"db": "BOOLEAN", 'is_feature': True},
    "entry_phone": {"db": "BOOLEAN", 'is_feature': True},
    "antibulglar_doors_windows": {"db": "BOOLEAN", 'is_feature': True},
    "alarm_system": {"db": "BOOLEAN", 'is_feature': True},
    "antibulglar_blinds": {"db": "BOOLEAN", 'is_feature': True},
    "dishwasher": {"db": "BOOLEAN", 'is_feature': True},
    "cooker": {"db": "BOOLEAN", 'is_feature': True},
    "fridge": {"db": "BOOLEAN", 'is_feature': True},
    "oven": {"db": "BOOLEAN", 'is_feature': True},
    "washing_machine": {"db": "BOOLEAN", 'is_feature': True},
    "tv": {"db": "BOOLEAN", 'is_feature': True},
    "elevator": {"db": "BOOLEAN", 'is_feature': True},
    "phone": {"db": "BOOLEAN", 'is_feature': True},
    "AC": {"db": "BOOLEAN", 'is_feature': True},
    "garden": {"db": "BOOLEAN", 'is_feature': True},
    "bathtub": {"db": "BOOLEAN", 'is_feature': True},
    "utility_room": {"db": "BOOLEAN", 'is_feature': True},
    "parking_space": {"db": "BOOLEAN", 'is_feature': True},
    "terrace": {"db": "BOOLEAN", 'is_feature': True},
    "balcony": {"db": "BOOLEAN", 'is_feature': True},
    "separate_kitchen": {"db": "BOOLEAN", 'is_feature': True},
    "basement": {"db": "BOOLEAN", 'is_feature': True},
    "virtual_walk": {"db": "BOOLEAN", 'is_feature': True},
    "two_level_apartment": {"db": "BOOLEAN", 'is_feature': True},
    "connecting_room": {"db": "BOOLEAN", 'is_feature': True},
    "pet_friendly": {"db": "BOOLEAN", 'is_feature': True},
}
