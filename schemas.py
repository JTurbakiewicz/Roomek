...
offer_scheme = {
    ...
    "rental_for_students": {"db": "varchar(25)"},
    "location_latitude": {"db": "LONGTEXT"},
    "location_longitude": {"db": "FLOAT"},
    "type_of_room": {"db": "varchar(50)"},
    "preferred_locator": {"db": "varchar(50)"},
    "scraped_ranking": {"db": "FLOAT"},
}
