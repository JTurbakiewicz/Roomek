...
offer_scheme = {
    ...
    "rental_for_students": {"db": 'BOOLEAN', 'item_loaders': [], 'scraping_path_olx': '',
                            ...
                            'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': True},
    "location_latitude": {"db": "FLOAT", 'item_loaders': [], 'scraping_path_olx': '', 'misc': [],
                          'scraping_path_otodom': '', 'scraping_path_olxroom': '', 'is_feature': True},
...
query_scheme = {
    ...
    # address:
    "country": {"db": "varchar(50)", 'is_feature': False, 'comparator': '='},
    "district": {"db": "varchar(50)", 'is_feature': False, 'comparator': '='},
    "street": {"db": "varchar(50)", 'is_feature': False, 'comparator': '='},
    "latitude": {"db": "FLOAT", 'is_feature': False, 'comparator': '='},
    "longitude": {"db": "FLOAT", 'is_feature': False, 'comparator': '='},
    # features:
