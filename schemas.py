...
regex_scheme = {
    ...
    "ready_from": {datetime.date.today(): ['od zaraz'],
                   datetime.date.today().replace(month=1, day=1): ['od(.{,15})stycz(.{,15})'],
    ...
    "rental_for_students": {True: [r'(.*) studencki', r'dla(.{,15})student(.*)', 'Wynajmę(.{,50})studentom']},
    ...
    "terrace": {True: ['z tarasem'],
                False: ['brak tarasu']},
    "balcony": {'regex': []},
    "non_smokers_only": {True: [r'dla niepaląc(.*)', r'tylko niepaląc(.*)', r'osoby niepaląc(.*)'],
                         False: [r'także paląc(.*)']},
    "separate_kitchen": {True: [r'osobna kuchnia']},
    "basement": {'regex': []},
    "virtual_walk": {'regex': []},
