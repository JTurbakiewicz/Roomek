...
user_questions = {
    ...
    "price": {"question": ["Ile chciałbyś maksymalnie płacić?"],
              ...
              "responses_buy_apartment": ['Do 100000 zł', 'Do 250000 zł', 'Do 500000 zł', 'Do 750000 zł',
                                          'Dowolna kwota'],
              "responses_buy_house": ['Do 200000 zł', 'Do 400000 zł', 'Do 700000 zł', 'Do 1000000 zł',
                                      'Dowolna kwota']},
...
user_questions_translations = {
    ...
    'Miejsce postojowe': 'parking_space',
...
query_scheme = {
    "query_no": {"db": "int(1) NOT NULL", 'to_compare': False, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    "facebook_id": {"db": "char(100) NOT NULL", 'to_compare': False, 'comparator': '=', 'is_feature': False,
                    'default': 1.0},
    "city": {"db": "varchar(50)", 'to_compare': True, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    "housing_type": {"db": "varchar(50)", 'to_compare': True, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    # room, apartment
    "business_type": {"db": "varchar(50)", 'to_compare': True, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    # rent, buy
    "price": {"db": "int(1)", 'to_compare': False, 'comparator': '<=', 'is_feature': False, 'default': 1.0},
    "total_price": {"db": "int(1)", 'to_compare': False, 'comparator': '<=', 'is_feature': True, 'default': 1.0},
    # address:
    "country": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    "district": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    "street": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    "latitude": {"db": "FLOAT", 'to_compare': False, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    "longitude": {"db": "FLOAT", 'to_compare': False, 'comparator': '=', 'is_feature': False, 'default': 1.0},
    # features:
    "date_of_the_offer": {"db": "DATETIME", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.7},
    "offer_from": {"db": "varchar(25)", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.3},
    "apartment_level": {"db": "smallint(1)", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                        'default': 0.3},
    "furniture": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.3},
    "type_of_building": {"db": "varchar(25)", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                         'default': 0.01},
    "area": {"db": "smallint(1)", 'to_compare': False, 'comparator': '>', 'is_feature': True, 'default': 0.5},
    "amount_of_rooms": {"db": "int(1)", 'to_compare': False, 'comparator': '>=', 'is_feature': True, 'default': 0.1},
    "additional_rent": {"db": "int(1)", 'to_compare': False, 'comparator': '<=', 'is_feature': True, 'default': 0.01},
    "price_per_m2": {"db": "int(1)", 'to_compare': False, 'comparator': '<=', 'is_feature': True, 'default': 0.2},
    "type_of_market": {"db": "varchar(25)", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "security_deposit": {"db": "smallint(1)", 'to_compare': False, 'comparator': '<=', 'is_feature': True,
                         'default': 0.01},
    "building_material": {"db": "varchar(25)", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                          'default': 0.01},
    "windows": {"db": "varchar(25)", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "heating": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "building_year": {"db": "SMALLINT(1)", 'to_compare': False, 'comparator': '>=', 'is_feature': True,
                      'default': 0.03},
    "fit_out": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "ready_from": {"db": "DATETIME", 'to_compare': False, 'comparator': '<=', 'is_feature': True, 'default': 0.1},
    "type_of_ownership": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                          'default': 0.01},
    "rental_for_students": {"db": 'BOOLEAN', 'to_compare': True, 'comparator': '=', 'is_feature': True,
                            'default': 0.01},
    "type_of_room": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "preferred_locator": {"db": "varchar(50)", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                          'default': 0.05},
    "non_smokers_only": {"db": "BOOLEAN", 'to_compare': True, 'comparator': '=', 'is_feature': True, 'default': 0.01},
    "internet": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "cable_tv": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "closed_terrain": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "monitoring_or_security": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                               'default': 0.08},
    "entry_phone": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.08},
    "antibulglar_doors_windows": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                                  'default': 0.01},
    "alarm_system": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.03},
    "antibulglar_blinds": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                           'default': 0.01},
    "dishwasher": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.09},
    "cooker": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "fridge": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "oven": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.08},
    "washing_machine": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "tv": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "elevator": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "phone": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.01},
    "AC": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "garden": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "bathtub": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.03},
    "utility_room": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.01},
    "parking_space": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.07},
    "terrace": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.07},
    "balcony": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.07},
    "separate_kitchen": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "basement": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.05},
    "virtual_walk": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.01},
    "two_level_apartment": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True,
                            'default': 0.03},
    "connecting_room": {"db": "BOOLEAN", 'to_compare': False, 'comparator': '=', 'is_feature': True, 'default': 0.1},
    "pet_friendly": {"db": "BOOLEAN", 'to_compare': True, 'comparator': '=', 'is_feature': True, 'default': 0.01},
}
...
regex_scheme = {
    ...
    "security_deposit": {0: ['bez kaucji', 'brak kaucji'],
                         'zł': [r'(kaucja\D{,25})(\d[\d\s]*)', r'(kaucja zwrotna\D{,25})(\d[\d\s]*)',
                                r'(kaucji\D{,25})(\d[\d\s]*)']},
    ...
    "windows": {'plastic': ['okna.{,3}plastik', 'okna.{,3}PCV', 'okna.{,3}PVC'],
                'wood': ['okna.{,3}drewnian'],
                'aluminium': ['okna.{,3}alumin']},
    "heating": {'electric': ['ogrzewanie.{,3}elek'],
                'gas': ['ogrzewanie.{,3}gaz', 'ogrzewanie.{,3}centralne.{,3}gazowe', 'ogrzewanie własne gazowe'],
                'other': [],
                'tiled stove': [],
                'urban': ['ogrzewanie.{,3}miejs', 'ogrzewanie z sieci',
                          'ogrzewanie.{,3}cieplik miejski', ]},
    "building_year": {'regex': []},
    ...
    "antibulglar_doors_windows": {True: ['drzwi anty.{,3}w[lł]amaniowe', 'okna anty.{,3}w[lł]amaniowe']},
...
for x, y in weights_scheme.items():
    dict_data = y
    if not dict_data['is_feature']:
        to_delete.append(x)
    dict_data["db"] = 'FLOAT'
    del dict_data['to_compare']
    del dict_data['comparator']
    del dict_data['is_feature']
    weights_scheme[x] = dict_data

for item in to_delete:
    del weights_scheme[item]
